...
/**
 * Test class for creating conference room: Training Room
 */
class TrainingConferenceTest extends CreateConferenceRoomsTest
{
    /**
    ...
    {
        return ConferenceRoomsDataFactory::getConferenceRoomData('training.conference');
    }
}
