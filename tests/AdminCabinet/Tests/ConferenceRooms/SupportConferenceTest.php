...
/**
 * Test class for creating conference room: Support Team Conference
 */
class SupportConferenceTest extends CreateConferenceRoomsTest
{
    /**
    ...
    {
        return ConferenceRoomsDataFactory::getConferenceRoomData('support.conference');
    }
}
