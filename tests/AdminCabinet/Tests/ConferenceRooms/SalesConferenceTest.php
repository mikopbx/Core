...
/**
 * Test class for creating conference room: Sales Team Conference
 */
class SalesConferenceTest extends CreateConferenceRoomsTest
{
    /**
    ...
    {
        return ConferenceRoomsDataFactory::getConferenceRoomData('sales.conference');
    }
}
