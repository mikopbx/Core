...
/**
 * Test class for creating conference room: Partner Conference
 */
class PartnerConferenceTest extends CreateConferenceRoomsTest
{
    /**
    ...
    {
        return ConferenceRoomsDataFactory::getConferenceRoomData('partner.conference');
    }
}
