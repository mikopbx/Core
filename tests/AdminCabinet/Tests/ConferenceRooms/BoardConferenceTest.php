...
/**
 * Test class for creating conference room: Board Room
 */
class BoardConferenceTest extends CreateConferenceRoomsTest
{
    /**
    ...
    {
        return ConferenceRoomsDataFactory::getConferenceRoomData('board.conference');
    }
}
