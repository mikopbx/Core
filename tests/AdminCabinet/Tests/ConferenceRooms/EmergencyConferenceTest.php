...
/**
 * Test class for creating conference room: Emergency Response
 */
class EmergencyConferenceTest extends CreateConferenceRoomsTest
{
    /**
    ...
    {
        return ConferenceRoomsDataFactory::getConferenceRoomData('emergency.conference');
    }
}
