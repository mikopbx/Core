...
/**
 * Test class for creating conference room: All Hands Meeting
 */
class AllHandsConferenceTest extends CreateConferenceRoomsTest
{
    /**
    ...
    {
        return ConferenceRoomsDataFactory::getConferenceRoomData('all.hands.conference');
    }
}
