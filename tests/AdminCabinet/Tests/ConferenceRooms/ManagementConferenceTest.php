...
/**
 * Test class for creating conference room: Management Conference
 */
class ManagementConferenceTest extends CreateConferenceRoomsTest
{
    /**
    ...
    {
        return ConferenceRoomsDataFactory::getConferenceRoomData('management.conference');
    }
}
