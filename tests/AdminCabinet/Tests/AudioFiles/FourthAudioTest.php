...
/**
 * Test class for creating Fourth Audio audio file
 *
 * Name: The fourth audio record
 * File: first_noel.mp3
 * Description: Christmas Music (For Delete)
 * Purpose: Test File (For Delete)
 */
class FourthAudioTest extends CreateAudioFileTest
{
    protected function getAudioFileData(): array
    {
        return AudioFilesDataFactory::getAudioFileData('fourth.audio');
    }
