...
/**
 * Test class for creating dialplan application: REST API Example
 */
class RestApiExampleTest extends CreateDialPlanApplicationTest
{
    /**
    ...
    {
        return DialplanApplicationsDataFactory::getApplicationData('rest.api.example');
    }
}
