...
/**
 * Test class for creating dialplan application: Callback Service
 */
class CallbackServiceTest extends CreateDialPlanApplicationTest
{
    /**
    ...
    {
        return DialplanApplicationsDataFactory::getApplicationData('callback.service');
    }
}
