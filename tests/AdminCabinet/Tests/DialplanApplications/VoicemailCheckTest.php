...
/**
 * Test class for creating dialplan application: Voicemail Check
 */
class VoicemailCheckTest extends CreateDialPlanApplicationTest
{
    /**
    ...
    {
        return DialplanApplicationsDataFactory::getApplicationData('voicemail.check');
    }
}
