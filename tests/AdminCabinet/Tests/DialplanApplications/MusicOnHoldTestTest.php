...
/**
 * Test class for creating dialplan application: Music On Hold Test
 */
class MusicOnHoldTestTest extends CreateDialPlanApplicationTest
{
    /**
    ...
    {
        return DialplanApplicationsDataFactory::getApplicationData('music.on.hold.test');
    }
}
