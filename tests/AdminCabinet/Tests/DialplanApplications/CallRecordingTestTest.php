...
/**
 * Test class for creating dialplan application: Call Recording Test
 */
class CallRecordingTestTest extends CreateDialPlanApplicationTest
{
    /**
    ...
    {
        return DialplanApplicationsDataFactory::getApplicationData('call.recording.test');
    }
}
