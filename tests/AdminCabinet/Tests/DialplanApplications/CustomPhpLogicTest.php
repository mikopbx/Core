...
/**
 * Test class for creating dialplan application: Custom PHP Logic
 */
class CustomPhpLogicTest extends CreateDialPlanApplicationTest
{
    /**
    ...
    {
        return DialplanApplicationsDataFactory::getApplicationData('custom.php.logic');
    }
}
