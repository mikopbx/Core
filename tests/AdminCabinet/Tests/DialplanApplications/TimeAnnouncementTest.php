...
/**
 * Test class for creating dialplan application: Time Announcement
 */
class TimeAnnouncementTest extends CreateDialPlanApplicationTest
{
    /**
    ...
    {
        return DialplanApplicationsDataFactory::getApplicationData('time.announcement');
    }
}
