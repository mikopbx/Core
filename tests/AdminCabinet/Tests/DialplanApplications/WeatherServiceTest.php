...
/**
 * Test class for creating dialplan application: Weather Information
 */
class WeatherServiceTest extends CreateDialPlanApplicationTest
{
    /**
    ...
    {
        return DialplanApplicationsDataFactory::getApplicationData('weather.service');
    }
}
