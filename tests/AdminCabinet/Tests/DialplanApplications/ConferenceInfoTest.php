...
/**
 * Test class for creating dialplan application: Conference Information
 */
class ConferenceInfoTest extends CreateDialPlanApplicationTest
{
    /**
    ...
    {
        return DialplanApplicationsDataFactory::getApplicationData('conference.info');
    }
}
