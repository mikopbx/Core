...
/**
 * Test class for creating dialplan application: Company Directory
 */
class DirectoryServiceTest extends CreateDialPlanApplicationTest
{
    /**
    ...
    {
        return DialplanApplicationsDataFactory::getApplicationData('directory.service');
    }
}
