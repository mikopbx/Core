...
/**
 * Test class for creating dialplan application: Echo Test Application
 */
class EchoTestTest extends CreateDialPlanApplicationTest
{
    /**
    ...
    {
        return DialplanApplicationsDataFactory::getApplicationData('echo.test');
    }
}
