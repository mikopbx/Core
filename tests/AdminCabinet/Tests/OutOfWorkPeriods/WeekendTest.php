...
/**
* Test class for creating Weekend period
*
* Description: Weekend
* Type: Weekly
* Time: Weekdays Saturday to Sunday
* Action: Play message ID 1
*/
class WeekendTest extends CreateOutOfWorkPeriodTest
{
    protected function getPeriodData(): array
    {
        return OutOfWorkPeriodsDataFactory::getPeriodData('weekend');
    }
}
