...
/**
* Test class for creating May Holidays period
*
* Description: First May holidays
* Type: Date Range
* Time: From 1 May, 2020 to 3 May, 2020
* Action: Play message ID 1
*/
class MayHolidaysTest extends CreateOutOfWorkPeriodTest
{
    protected function getPeriodData(): array
    {
        return OutOfWorkPeriodsDataFactory::getPeriodData('may.holidays');
    }
}
