...
/**
 * Test class for creating Nikolay macbook firewall rule
 */
class NikolayMacbookTest extends CreateFirewallRuleTest
{
    protected function getRuleData(): array
    {
        return FirewallRulesDataFactory::getRuleData('nikolay.macbook');
    }
}
