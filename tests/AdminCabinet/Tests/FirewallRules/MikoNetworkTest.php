...
/**
 * Test class for creating MikoNetwork firewall rule
 */
class MikoNetworkTest extends CreateFirewallRuleTest
{
    protected function getRuleData(): array
    {
        return FirewallRulesDataFactory::getRuleData('miko.network');
    }
}
