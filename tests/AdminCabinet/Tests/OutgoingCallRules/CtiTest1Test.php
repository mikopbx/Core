...
/**
 * Test class for creating Outgoing calls for CTI tests 1
 * 
 * Rule Type: Test
 * Name: Outgoing calls for CTI tests 1
 * Pattern: Any
 ...
 * - Prepend: 7
 */
class CtiTest1Test extends CreateOutgoingCallRuleTest
{
    protected function getRuleData(): array
    {
        return OutgoingCallRulesDataFactory::getRuleData('cti.test.1');
    }
