...
/**
 * Test class for creating secondAmiUser4Test AMI user
 */
class SecondAmiUserTest extends CreateAmiUserTest
{
    protected function getAmiUserData(): array
    {
        return AmiUserDataFactory::getAmiUserData('second.ami.user');
    }
}
