...
/**
 * Test class for creating No Registration (IP Authentication) IAX provider
 */
class NoRegistrationIaxTest extends CreateIAXProviderTest
{
    protected function getIAXProviderData(): array
    {
        return IAXProviderDataFactory::getIAXProviderData('provider.iax.noregistration');
    }
