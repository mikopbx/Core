...
/**
 * Test class for creating Inbound IAX provider
 */
class InboundIaxTest extends CreateIAXProviderTest
{
    protected function getIAXProviderData(): array
    {
        return IAXProviderDataFactory::getIAXProviderData('provider.iax.inbound');
    }
