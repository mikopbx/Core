...
/**
 * Test class for creating extension for Eugeniy Makrchev
 */
class EugeniyMakrchevTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('eugeniy.makrchev');
    }
}
