...
/**
 * Test class for creating extension for Nikolay Beketov
 */
class NikolayBeketovTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('nikolay.beketov');
    }
}
