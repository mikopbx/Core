...
/**
 * Test class for creating extension for Anton Pasutin
 */
class AntonPasutinTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('anton.pasutin');
    }
}
