...
/**
 * Test class for creating extension for Ivan Maltsev
 */
class IvanMaltsevTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('ivan.maltsev');
    }
}
