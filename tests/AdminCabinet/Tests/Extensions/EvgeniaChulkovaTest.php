...
/**
 * Test class for creating extension for Evgenia Chulkova
 */
class EvgeniaChulkovaTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('evgenia.chulkova');
    }
}
