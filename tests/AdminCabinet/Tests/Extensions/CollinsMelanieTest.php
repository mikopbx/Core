...
/**
 * Test class for creating extension for Collins Melanie
 */
class CollinsMelanieTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('collins.melanie');
    }
}
