...
/**
 * Test class for creating extension for Julia Efimova
 */
class JuliaEfimovaTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('julia.efimova');
    }
}
