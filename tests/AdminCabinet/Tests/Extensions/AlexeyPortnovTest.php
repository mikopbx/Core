...
/**
 * Test class for creating extension for Alexey Portnov
 */
class AlexeyPortnovTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('alexey.portnov');
    }
}
