...
/**
 * Test class for creating extension for Natalia Beketova
 */
class NataliaBeketovaTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('natalia.beketova');
    }
}
