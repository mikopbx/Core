...
/**
 * Test class for creating extension for Alexandr Medvedev
 */
class AlexandrMedvedevTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('alexandr.medvedev');
    }
}
