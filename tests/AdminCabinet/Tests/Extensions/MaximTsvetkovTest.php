...
/**
 * Test class for creating extension for Maxim Tsvetkov
 */
class MaximTsvetkovTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('maxim.tsvetkov');
    }
}
