...
/**
 * Test class for creating extension for Ilia Tsvetkov
 */
class IliaTsvetkovTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('ilia.tsvetkov');
    }
}
