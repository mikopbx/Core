...
/**
 * Test class for creating extension for Anna Mzhelskaya
 */
class AnnaMzhelskayaTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('anna.mzhelskaya');
    }
}
