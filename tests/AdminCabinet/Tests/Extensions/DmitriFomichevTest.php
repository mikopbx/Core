...
/**
 * Test class for creating extension for Dmitri Fomichev
 */
class DmitriFomichevTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('dmitri.fomichev');
    }
}
