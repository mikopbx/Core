...
/**
 * Test class for creating extension for Alisher Usmanov
 */
class AlisherUsmanovTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('alisher.usmanov');
    }
}
