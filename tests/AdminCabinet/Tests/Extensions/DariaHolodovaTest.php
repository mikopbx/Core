...
/**
 * Test class for creating extension for Daria Holodova
 */
class DariaHolodovaTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('daria.holodova');
    }
}
