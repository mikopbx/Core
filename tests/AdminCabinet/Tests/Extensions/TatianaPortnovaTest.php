...
/**
 * Test class for creating extension for Tatiana Portnova
 */
class TatianaPortnovaTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('tatiana.portnova');
    }
}
