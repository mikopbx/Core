...
/**
 * Test class for creating extension for Brown Brandon
 */
class BrownBrandonTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('brown.brandon');
    }
}
