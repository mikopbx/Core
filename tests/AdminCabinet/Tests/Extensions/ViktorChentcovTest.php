...
/**
 * Test class for creating extension for Viktor Chentcov
 */
class ViktorChentcovTest extends CreateExtensionsTest
{
    /**
    ...
    {
        return EmployeeDataFactory::getEmployeeData('viktor.chentcov');
    }
}
