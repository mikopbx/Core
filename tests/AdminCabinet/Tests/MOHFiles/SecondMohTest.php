...
/**
 * Test class for creating Second Moh MOH audio file
 * 
 * Name: The second MOH audio record
 * File: blind_willie.mp3
 * Description: Blues Music
 */
class SecondMohTest extends CreateMOHAudioFileTest
{
    protected function getAudioFileData(): array
    {
        return MOHAudioFilesDataFactory::getAudioFileData('second.moh');
    }
