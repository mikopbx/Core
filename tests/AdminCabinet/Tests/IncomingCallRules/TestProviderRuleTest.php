...
/**
 * Test class for creating Rule for test provider
 * 
 * Name: Rule for test provider
 * Provider: Provider for CTI tests
 * Number: Any
 * Extension: 202
 * Description: Complex routing rule with IVR logic
 */
class TestProviderRuleTest extends CreateIncomingCallRuleTest
{
    protected function getRuleData(): array
    {
        return IncomingCallRulesDataFactory::getRuleData('test.provider.rule');
    }
}
