...
if (!$GLOBALS['SERVER_PBX']) {
    $GLOBALS['SERVER_PBX'] = 'https://172.16.33.72';
}
...
$GLOBALS['SSH_RSA_KEYS_SET'] = getenv('SSH_RSA_KEYS_SET');
if (!$GLOBALS['SSH_RSA_KEYS_SET']) {
    $GLOBALS['SSH_RSA_KEYS_SET'] = $GLOBALS['CONFIG']['SSH_RSA_KEYS_SET'];
}
