        ...
        foreach ($entity as $key=>$value) {
            switch ($key){
                case 'id' :
                    ...
                    break;
                case 'extension' :
                    $extension= new Select($key, $options['extensions'], array(
                        'using' => array(
                            'id',
                            'name'
                        ),
                ...
                case 'audio_message_id' :
                    $audiomessageid= new Select($key, $options['audio-message'], array(
                        'using' => array(
                            'id',
                            'name'
                        ),
                    ...
                    break;
                case 'action' :
                    $action= new Select($key, $options['available-actions'], array(
                        'using' => array(
                            'id',
                            'name'
                        ),
                ...
                case 'weekday_from' :
                case 'weekday_to' :
                    $action= new Select($key, $options['week-days'], array(
	                    'using'    => array(
                            'id',
                            'name'
                        ),
