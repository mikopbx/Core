...
var extension = {
  ...
  initialize: function () {
    function initialize() {
      ...
      var maskList = $.masksSort(maskListUnsorted, ['#'], /[0-9]|#/, 'mask');
      extension.$mobile_number.inputmasks({
        inputmask: {
          ...
          oncomplete: extension.cbOnCompleteMobileNumber // clearIncomplete: true,
  ...
  cbOnClearedMobileNumber: function () {
    function cbOnClearedMobileNumber() {
      extension.$formObj.form('set value', 'mobile_dialstring', ''); // Проверим не была ли настроена переадресация на мобильный номер
...
//# sourceMappingURL=extension-modify.js.map