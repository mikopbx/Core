...
return [
	...
	'SubHeaderBackup'                                             => 'Save and restore settings of the PBX and a Call detail records (CDR)',
	'BreadcrumbBackupcreate'                                      => 'Backup',
	'BreadcrumbBackuprestore'                                     => 'Restore backup',
	...
	'mm_ModuleSmartIVR'             => 'Smart IVR from 1C',
	'mm_ModuleCTIClient'            => 'CTI Client',
	...
	'pr_DefaultUser'                                =>'Some providers require a seperate username for authorization (defaultuser). Defaults to username entered above.',
	'pr_FromUser'                                   =>'Some providers require a seperate \'from\' user (fromuser). Defaults to username entered above.',
	'pr_FromDomain'                                 =>'Some providers require a seperate \'from\' domain (fromdomain). Defaults to host entered above.',
	...
	'pr_ManualRegisterString'        =>'Completely override the generated registration string (register)',
 ...
 Only if you do not have calls and the provider requires special settings, then these fields must be filled in according to the recommendation of the provider.</div>',
	...
	'or_ValidationPleaseSelectProvider'			  => 'Select provider please',
	...
	'cq_fewestcalls'                     => 'The call is received by the queue member that processed the least number of calls',
	...
	'ex_dropdownCategory_DIALPLAN_APPLICATION' => 'Application dialplans',
	'ex_dropdownCategory_IVR_MENU'             => 'Interactive Voice Response (IVR) Menu',
	'ex_dropdownCategory_QUEUE'                => 'Call queue',
	...
	'tf_SelectAudioMessage'              => 'Select the audio file',
	'tf_SelectExtension'                 => 'Select extension',
	'tf_ValidateCheckDateInterval'       => 'Check the date interval',
	'tf_ValidateCheckWeekDayInterval'    => 'Check interval, days of the week',
	'tf_ValidateCheckTimeInterval'       => 'Check the time interval',
	'tf_ValidateAudioMessageEmpty'       => 'Select audio recording',
	'tf_ValidateExtensionEmpty'                                   => 'Select an extension number to forward to',
	'tf_ValidateNoRulesSelected'                                  => 'No period of time is filled',
	'Mon'                                                         =>'Monday',
	'Tue'                                                         =>'Tuesday',
	'Wed'                                                         =>'Wednesday',
	'Thu'                                                         =>'Thursday',
	...
	'fw_sipDescription'                                           =>'SIP - phone registration and voice traffic',
	...
	'fw_AdditionalRules'                                          =>'Advanced setting',
	'fw_StatusEnabled'                                            => 'Firewall and anti-hacking protection included',
	...
	'gs_PBXLanguage'                                =>'Web interface and PBX messages language',
	'gs_PBXInternalExtensionLength'                 =>'Length of internal numbers',
	...
	'gs_SIPDefaultExpiry'                =>'Time after which registration will be reset',
	...
	'ms_NotificationTemplates'              =>'Alert templates',
	...
	'cr_ColumnExtension'                        =>'Extension',
	'cr_ColumnName'                             =>'Name',
	'cr_Name'                                   =>'Conference room name',
	'cr_Extensions'                             =>'Extension',
	...
	'cf_Mode'=>'Mode',
	'mo_BeforeDeleteFirst'=>'Before delete first %repesent%',
	'ConstraintViolation'=>'<div class=\'header\'>Logical integrity violation</div>',
	'repAsteriskManagerUsers'=>'AMI record - %repesent%',
	'repCallQueues'=>'Call queue - %repesent%',
	'repCallQueueMembers'=>'Call queue member - %repesent%',
	'repConferenceRooms'=>'Conference room - %repesent%',
	'repCustomFiles'=>'System file - %repesent%',
	'repDialplanApplications'=>'Dialplan application - %repesent%',
	'repExtensionForwardingRights'     =>'Employee routing settings - %repesent%',
	'repExtensions'                    =>'Extension - %repesent%',
	'repExternalPhones'                =>'External number - %repesent%',
	'repFail2BanRules'                              =>'Fail2Ban rule - %repesent%',
	'repFirewallRules'                              =>'Firewall rule- %repesent%',
	'repIax'                                        =>'IAX account - %repesent%',
	'repIaxCodecs'                                  =>'Setting up the IAX codec - %repesent%',
	'repIncomingRoutingTable'                       =>'Inbound routing rule - %repesent%',
	'repLanInterfaces'                              =>'System file - %repesent%',
	'repNetworkFilters'                             => 'Network filter - %repesent%',
	'repOutgoingRoutingTable'                       => 'Outbound routing rule - %repesent%',
	'repOutWorkTimes'                               => 'Night and Holiday Switch - %repesent%',
	'repPbxSettings'                         => 'PBX settings - %repesent%',
	'repSip'                                 => 'Sip account - %repesent%',
	'repSipCodecs'                           => 'Codec SIP - %repesent%',
	'repSoundFiles'                          => 'Audio file - %repesent%',
	'repIvrMenu'                             => 'IVR menu - %repesent%',
	'repIvrMenuActions'                      => 'IVR menu member - %repesent%',
	'repLink'                                => 'Link',
...
It can be activated once, after which the coupon becomes redeemed.
	...
	'lic_ResetLicenseSettings'              => 'Reset settings',
	...
	'lic_FailedToGetTrialKey2051'			=> 'Failed to register: (2051) You have already got trial key on this host for other email/company',
	'lic_FailedToGetTrialKey2022'			=> 'Failed to register: (2022) This email has already used for other company name',
...
<br>The system will form a snapshot of the system state in the form of an archive.</div>',
	...
	'upd_UpdateTitle'				 => 'System upgrade',
	...
	'mo_ModuleShort4Dropdown'               => 'Modile',
	...
	'adv_YouUseDefaultWebPassword' 			=> 'You use the default password to log in to the administrative interface - <a href=\'%url%\'>change</a>',
	'adv_YouUseDefaultSSHPassword' 			=> 'You are using the default password for SSH access - <a href=\'%url%\'>change</a>',
	'adv_FirewallDisabled'         			=> 'The firewall is disabled in the PBX - <a href=\'%url%\'>change</a>',
	'adv_NetworksNotConfigured'    			=> 'Network subnets don\'t configured  - <a href=\'%url%\'>изменить</a>',
	...
	'adv_ThisCopyIsNotRegistered'    		=> 'This program <a href=\'%url%\'>isn\'t registered</a>',
