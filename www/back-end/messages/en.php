...
return [
 ...
 Only if you do not have calls and the provider requires special settings, then these fields must be filled in according to the recommendation of the provider.</div>',
    ...
    'pr_DeleteDescription'                          => 'After deleting this provider all linked Outbound call rules will be deleted, also all links in Inbound call rules will be cleared.',
    'pr_Cancel'                                     => 'Cancel',
    'pr_Delete'                                     => 'Delete',
    ...
    'ms_TestEmailSentSuccessfully'     => 'Email successfully sent',
	...
	'repIaxCodecs'                                  =>'Setting up the IAX codec - %represent%',
	...
	'repSipCodecs'                           => 'Codec SIP - %represent%',
