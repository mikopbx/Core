...
- [ ] Баннер содержит все требуемые данные: версия, окружение, название PBX, адреса (IPv4/IPv6), uptime
...
**Функциональность:**
- [ ] Детальная сетевая информация показывает все IP адреса, маршруты (IPv4/IPv6), DNS серверы
...
- [ ] Добавлены переводы на 29 языков для новых ключей
