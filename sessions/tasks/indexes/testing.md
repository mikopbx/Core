...
## Completed Tasks
- `m-refactor-api-tests-hardcoded-params.md` - Eliminate hardcoded paths, URLs, passwords in 9 Python API test files; use centralized config.py and api_client fixture (completed 2026-03-01)
