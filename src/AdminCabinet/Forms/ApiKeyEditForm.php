 ...
 */
class ApiKeyEditForm extends BaseForm
{
    /**
     * Initialize the form
     *
     * @param object $entity The API key data structure
     * @param mixed $options Additional options including availableControllers
     */
