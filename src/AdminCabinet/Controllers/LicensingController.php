...
class LicensingController extends BaseController
{
    ...
    {
        if ($this->language === 'ru') {
            $this->view->modulesExampleImgPath = $this->url->get('public/assets/img/modules-example-ru.png');
        } else {
            $this->view->modulesExampleImgPath = $this->url->get('public/assets/img/modules-example-en.png');
        }
