...
class AssetsController extends BaseController
{
    ...
    private function makeAssets() {
        ...
        $cssCacheDir = $this->config->cssCacheDir;
        $jsCacheDir  = $this->config->jsCacheDir;
        ...
        if (file_exists('/tmp/sendmetrics')) {
            ...
            $headerCollectionSentryJS->addJs("public/assets/js/pbx/main/sentry-error-logger.js", true, false,'', $version);
        }

        $semanticCollectionCSS = $manager
            ->collection('SemanticUICSS');
        $semanticCollectionCSS
            ->addCss('css/vendor/semantic/grid.min.css', true, false)
            ->addCss('css/vendor/semantic/divider.min.css', true, false)
            ->addCss('css/vendor/semantic/container.min.css', true, false)
            ->addCss('css/vendor/semantic/header.min.css', true, false)
            ->addCss('css/vendor/semantic/button.min.css', true, false)
            ->addCss('css/vendor/semantic/form.min.css', true, false)
            ->addCss('css/vendor/semantic/icon.min.css', true, false)
            ->addCss('css/vendor/semantic/flag.min.css', true, false)
            ->addCss('css/vendor/semantic/image.min.css', true, false)
            ->addCss('css/vendor/semantic/input.min.css', true, false)
            ->addCss('css/vendor/semantic/message.min.css', true, false)
            ->addCss('css/vendor/semantic/segment.min.css', true, false)
            ->addCss('css/vendor/semantic/site.min.css', true, false)
            ->addCss('css/vendor/semantic/reset.min.css', true, false)
            ->addCss('css/vendor/semantic/transition.min.css', true, false)
            ->addCss('css/vendor/semantic/dropdown.min.css', true, false);
        ...
        $semanticCollectionJS
            ->addJs('js/vendor/semantic/form.min.js', true, false)
            ->addJs('js/vendor/semantic/api.min.js', true, false)
            ->addJs('js/vendor/semantic/site.min.js', true, false)
            ->addJs('js/vendor/semantic/popup.min.js', true, false)
            ->addJs('js/vendor/semantic/dropdown.min.js', true, false)
            ->addJs('js/vendor/semantic/transition.min.js', true, false);

        // Если пользователь залогинился, сформируем необходимые CSS кеши
        if ($session && $session->has('auth')) {
            $semanticCollectionCSS
                ->addCss('css/vendor/semantic/menu.min.css', true, false)
                ->addCss('css/vendor/semantic/sidebar.min.css', true, false)
                ->addCss('css/vendor/semantic/table.min.css', true, false)
                ->addCss('css/vendor/semantic/loader.min.css', true, false)
                ->addCss('css/vendor/semantic/label.min.css', true, false)
                ->addCss('css/vendor/semantic/dimmer.min.css', true, false)
                ->addCss('css/vendor/semantic/accordion.min.css', true, false)
                ->addCss('css/vendor/semantic/placeholder.min.css', true, false)
                ->addCss('css/vendor/semantic/item.min.css', true, false)
                ->addCss('css/vendor/semantic/tab.min.css', true, false)
                ->addCss('css/vendor/semantic/checkbox.min.css', true, false)
                ->addCss('css/vendor/semantic/popup.min.css', true, false)
                ->addCss('css/vendor/semantic/toast.min.css', true, false);

            $semanticCollectionJS
                ->addJs('js/vendor/semantic/accordion.min.js', true, false)
                ->addJs('js/vendor/semantic/dimmer.min.js', true, false)
                ->addJs('js/vendor/semantic/sidebar.min.js', true, false)
                ->addJs('js/vendor/semantic/checkbox.min.js', true, false)
                ->addJs('js/vendor/semantic/toast.min.js', true, false)
                ->addJs('js/vendor/semantic/tab.min.js', true, false);
            ...
            $footerCollectionJS
                ...
                ->addJs('js/pbx/PbxExtensionModules/pbx-extension-menu-addition.js',
                    true,
                    true)
                ->addJs('js/pbx/TopMenuSearch/top-menu-search.js',
                    true,
                    true);
        ...
        switch ($controller) {
            ...
            case 'Backup':
                if ($action === 'index') {
                    $semanticCollectionCSS->addCss('css/vendor/semantic/progress.min.css', true, false);
                    $semanticCollectionJS->addJs('js/vendor/semantic/progress.min.js', true, false);
                    $footerCollectionJS->addJs('js/vendor/resumableumable.js', true, true);
                    ...
                    $semanticCollectionCSS
                        ->addCss('css/vendor/semantic/progress.min.css', true, false)
                        ->addCss('css/vendor/semantic/modal.min.css', true, false);

                    $semanticCollectionJS
                        ->addJs('js/vendor/semantic/progress.min.js', true, false)
                        ->addJs('js/vendor/semantic/modal.min.js', true, false);

                    $footerCollectionJS
                        ->addJs('js/pbx/main/form.js', true, true)
                        ->addJs('js/pbx/Backup/backup-restore.js', true, true);
                } elseif ($action === 'automatic') {
                    $semanticCollectionCSS->addCss('css/vendor/semantic/calendar.min.css', true, false);
                    $semanticCollectionJS->addJs('js/vendor/semantic/calendar.min.js', true, false);
                    $footerCollectionJS
                        ->addJs('js/pbx/main/form.js', true, true)
            ...
            case 'CallDetailRecords':
                if ($action === 'index') {
                    ...
                    $semanticCollectionCSS
                        ->addCss('css/vendor/range/range.min.css', true, false)
                        ->addCss('css/vendor/datatable/scroller.dataTables.min.css', true, false)
                        ->addCss('css/vendor/datepicker/daterangepicker.css', true, false)
                        ->addCss('css/vendor/datatable/dataTables.semanticui.min.css', true, false);
                    ...
                    $semanticCollectionJS
                        ...
                        ->addJS('js/vendor/datepicker/moment.min.js', true, true)
                        ->addJS('js/vendor/datepicker/daterangepicker.js', true, true);
            ...
            case 'CallQueues':
                if ($action === 'index') {
                    $headerCollectionCSS
                        ->addCss('css/vendor/datatable/dataTables.semanticui.css', true, true);
                    $footerCollectionJS
                        ->addJs('js/vendor/datatable/dataTables.semanticui.js', true)
            ...
            case 'Extensions':
                if ($action === 'index') {
                    ...
                    $semanticCollectionCSS->addCss('css/vendor/semantic/card.min.css', true, false);
                    $footerCollectionJS
                        ->addJs('js/vendor/inputmask/inputmask.js', true)
                        ->addJs('js/vendor/inputmask/jquery.inputmask.js', true)
                        ->addJs('js/vendor/inputmask/jquery.inputmask-multi.js', true)
            ...
            case 'GeneralSettings':
                if ($action === 'modify') {
                    ...
                    $semanticCollectionJS->addJs('js/vendor/semantic/progress.min.js', true, false);
                    $footerCollectionJS
                        ->addJs('js/vendor/jquery.address.min.js', true, false)
                        ->addJs('js/pbx/main/form.js', true)
            ...
            case 'PbxExtensionModules':
                if ($action === 'index') {
                    $semanticCollectionJS->addJs('js/vendor/semantic/modal.min.js', true, false);
                    $footerCollectionJS
            ...
            case 'SoundFiles':
                if ($action === 'index') {
                    $headerCollectionCSS
                        ...
                        ->addCss('css/vendor/datatable/dataTables.semanticui.css',
                            true);
                    ...
                    $headerCollectionJS
                        ->addJs('js/vendor/webrtc/MediaStreamRecorder.min.js',
                            true)
        ...
        $langJSFile = "public/assets/js/cache/localization-{$language}-{$version}.min.js";
        ...
        $headerCollectionCSS->setTargetUri("public/assets/css/cache/{$resultCombinedName}header.min.css?v={$version}");
        ...
        $headerCollectionJSForExtensions->setTargetUri("public/assets/js/cache/{$resultCombinedName}header.min.js?v={$version}");
        ...
        $footerCollectionJSForExtensions->setTargetUri("public/assets/js/cache/{$resultCombinedName}footer.min.js?v={$version}");
