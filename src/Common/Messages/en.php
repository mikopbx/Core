...
<br>The system will save all packets passing at this moment through the network card for further analysis.',
    ...
    'lic_FailedCheckLicenseNotPbxResponse' => 'PBX did not respond to a request for information on the license. Service is unavailable.',
    ...
    'adv_SSHPasswordMismatchFilesHash' => 'The SSH MikoPBX password is different from the one set in the configuration file. Perhaps it was changed manually from the PBX console.',
