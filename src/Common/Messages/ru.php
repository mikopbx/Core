...
return [
    ...
    'pr_DefaultUser' => 'Некоторые провайдеры требуют дополнительно указать имя для авторизации (defaultuser), отличное от логина',
    'pr_FromUser' => 'Некоторые провайдеры требуют дополнительно указать поле (fromuser), отличное от логина',
    'pr_FromDomain' => 'Некоторые провайдеры требуют дополнительно указать значение (fromdomain)',
    ...
    'gs_SIPMinExpiry' => 'Минимальное время в секундах',
    'gs_SIPMaxExpiry' => 'Максимальное время в секундах',
