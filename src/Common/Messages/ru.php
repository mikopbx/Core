...
<br>Система сохранит все пакеты проходящие в этот момент через сетевую карту для дальнейшего анализа.',
    ...
    'upd_UpdateDescription' => 'После загрузки обновления, АТС перезагрузится автоматически, все текущие вызовы будут сброшены. Обязательно сделайте резервную копию MikoPBX перед обновлением.',
