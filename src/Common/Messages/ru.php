...
return [
    ...
    'gs_SSHPort' => 'SSH порт',
    'gs_SSHPPasswordCorrupt' => 'Пароль ssh, установленный в web интерфейсе, не совпадает с действующим в системе.',
...
<br>Система сохранит все пакеты проходящие в этот момент через сетевую карту для дальнейшего анализа.',
    ...
    'adv_isSimplePassword' => 'Используется не безопасный пароль для "%type%" - <a href=\'%url%\'>изменить</a>',
    'gs_WebPasswordFieldName' => 'Web интерфейс',
    'gs_SshPasswordFieldName' => 'SSH',
    'gs_UserPasswordFieldName' => 'Внутреннего номера <%extension%>',
