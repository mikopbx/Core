...
<br>Система сохранит все пакеты проходящие в этот момент через сетевую карту для дальнейшего анализа.',
    ...
    'iax_REG_TYPE_NONE' => 'Аутентификация по IP адресу, без пароля',
    'pr_IAXPort' => 'IAX порт',
    ...
    'pr_SecurityWarning' => 'Предупреждение безопасности',
    'pr_ReceiveCallsWithoutAuthWarning' => 'Включение этой опции позволит принимать звонки с любого IP-адреса без проверки пароля. Это существенно снижает безопасность системы. Используйте только в изолированных сетях или когда точно понимаете риски.',
