 ...
 */
    ...
    'nw_NATInfoInstruction1' => 'Если ваша сеть настроена на поддержку NAT 1:1 (обычно это правило используется в облаках по-умолчанию), вам не нужно выполнять дополнительных настроек.',
    'nw_NATInfoInstruction2' => 'Если NAT 1:1 не используется, перенаправьте указанные ниже порты с публичного IP на внутренний IP адрес MikoPBX.',
    'nw_NATInfoInstruction3' => '%SIP_PORT% TCP/UDP и %TLS_PORT% TCP',
    ...
    'nw_ExternIpHostInstruction1' => 'Если SIP порт на маршрутизаторе не %SIP_PORT%, укажите его после IP адреса или внешнего хоста, разделив двоеточием.',
    'nw_ExternIpHostInstruction2' => 'Если указано внешнее имя хоста, оно будет использоваться в приоритете вместо внешнего IP адреса.',
    'nw_UpdateExternalIPAutomaticallyOnReboot'=>'Обновлять внешний IP адрес MikoPBX при каждой перезагрузке',
    'gs_MainTab' => 'Основные',
