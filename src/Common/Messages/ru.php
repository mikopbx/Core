 ...
 */
    ...
    'iv_NumberOfRepeatTooltip_desc' => 'Определяет, сколько раз будет проигрываться голосовое приветствие, если абонент не делает выбор. После превышения указанного количества повторов звонок будет автоматически переведен на номер по умолчанию.',
    'iv_NumberOfRepeatTooltip_note' => 'Рекомендуемое значение: 3 повтора. Слишком большое количество повторов может раздражать звонящих.',
