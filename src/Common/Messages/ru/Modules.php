...
return [
    ...
    'ext_ConfigureModule' => 'Настроить модуль',
    'ext_ConfirmUpdate' => 'Применить обновление',
    ...
    'ext_ErrAnotherOperationInProgress' => 'Другая операция с модулями ещё выполняется. Дождитесь её завершения и повторите попытку.',
    ...
    'ext_FailedToLoadChangelog' => 'Не удалось загрузить описание изменений из репозитория. Попробуйте позже.',
    ...
    'ext_LoadingChangelog' => 'Загрузка описания изменений…',
    ...
    'ext_ModuleCrashLoopProblem' => 'Модуль был отключён автоматически из-за многократных сбоев воркера:',
    ...
    'ext_ModuleTypeAi' => 'AI / Обработка речи',
    'ext_ModuleTypeAll' => 'Все категории',
    'ext_ModuleTypeCallFeature' => 'Управление вызовами',
    'ext_ModuleTypeCti' => 'CTI / CRM интеграции',
    'ext_ModuleTypeFilter' => 'Категория модуля',
    'ext_ModuleTypeGeneral' => 'Общие',
    'ext_ModuleTypeLanguagepack' => 'Языковые пакеты',
    'ext_ModuleTypeSecurity' => 'Безопасность',
    'ext_ModuleTypeUtility' => 'Утилиты',
    ...
    'ext_NoChangelogAvailable' => 'Описание изменений для этого релиза не предоставлено.',
    ...
    'ext_OperationStalledError' => 'Операция с модулем перестала отвечать и была прервана. Проверьте журнал системы и повторите попытку.',
    ...
    'ext_UpdateAllModulesChangelogIntro' => 'Выберите модули, которые нужно обновить. Раскройте запись модуля, чтобы ознакомиться со списком изменений перед подтверждением.',
    ...
    'ext_UpdateAllModulesShort' => 'Обновить все',
    'ext_UpdateAllModulesTitle' => 'Обновление всех модулей',
    'ext_UpdateChangelogIntro' => 'Модуль <b>%name%</b> будет обновлён с версии <b>%from%</b> до версии <b>%to%</b>. Ознакомьтесь с изменениями ниже перед подтверждением.',
