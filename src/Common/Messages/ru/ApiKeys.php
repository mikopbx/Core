...
return [
    ...
    'ak_EndpointAsteriskRestUsers' => 'Asterisk REST пользователи',
    ...
    'ak_EndpointEmployees' => 'Управление сотрудниками',
    ...
    'ak_ApiKeyUsageTooltip_curl_example' => 'curl -H "Authorization: Bearer ВАШ_API_КЛЮЧ" "http://pbx.example.com/pbxcore/api/v3/employees?limit=20&offset=0"',
    'ak_ApiKeyUsageTooltip_js_example' => 'fetch("http://pbx.example.com/pbxcore/api/v3/employees?limit=20&offset=0", { headers: { "Authorization": "Bearer ВАШ_API_КЛЮЧ" } })',
    'ak_ApiKeyUsageTooltip_php_example' => '$ch = curl_init("http://pbx.example.com/pbxcore/api/v3/employees?limit=20&offset=0"); curl_setopt($ch, CURLOPT_HTTPHEADER, ["Authorization: Bearer ВАШ_API_КЛЮЧ"]);',
