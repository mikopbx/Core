...
<br>Система сохранит все пакеты проходящие в этот момент через сетевую карту для дальнейшего анализа.',
    ...
    'st_DiskSpeedWrite' => 'Запись',
    'st_DiskSpeedRead' => 'Чтение',
    'st_DiskSpeedUnit' => 'МБ/с',
    'st_DiskSpeedRunButton' => 'Замерить скорость диска',
    'st_DiskSpeedRunning' => 'Идёт замер…',
    'st_DiskSpeedNoData' => 'Замер ещё не выполнялся',
    'st_Day' => 'день',
    'st_Days' => 'дней',
    'st_1Month' => '1 месяц',
    'st_3Months' => '3 месяца',
    ...
    'storage_s3_preset_custom' => 'Другой / самостоятельная настройка',
    'storage_s3_preset_aws_hint' => 'Используйте регион AWS, в котором создан бакет (например, eu-central-1).',
    'storage_s3_preset_minio_hint' => 'Включён path-style. Регион можно оставить us-east-1, MinIO его игнорирует.',
    'storage_s3_preset_garage_hint' => 'Включён path-style. Регион должен совпадать с тем, что задан в конфигурации Garage (по умолчанию garage).',
    'storage_s3_preset_ceph_hint' => 'Включён path-style. Регион — это zonegroup, заданный при инициализации кластера.',
    'storage_s3_preset_wasabi_hint' => 'Используется virtual-hosted адресация. Endpoint зависит от региона (например, https://s3.eu-central-1.wasabisys.com).',
    'storage_s3_preset_digitalocean_hint' => 'Endpoint содержит регион (nyc3, ams3, sgp1, fra1). Используется virtual-hosted адресация.',
    'storage_s3_preset_yandex_hint' => 'Регион всегда ru-central1. Endpoint — https://storage.yandexcloud.net.',
    'storage_s3_preset_vkcloud_hint' => 'Endpoint зависит от региона (ru-msk, ru-spb).',
    'storage_s3_preset_selectel_hint' => 'Endpoint и регион указываются одинаково (например, ru-1). Используется virtual-hosted адресация.',
    'storage_s3_preset_custom_hint' => 'Введите параметры подключения вручную. Включите path-style URL, если это требует ваш провайдер (MinIO, Garage, Ceph, RadosGW и т.п.).',
    'st_S3ErrorCodePrefix' => 'Код ошибки AWS',
    'st_S3ErrorTypePrefix' => 'Тип ошибки',
    ...
    'st_tooltip_s3_preset_desc' => 'Выберите провайдера, чтобы автоматически подставить корректные значения endpoint, региона и режима адресации (path-style для MinIO, Garage, Ceph). Engine-код всё равно работает с явными настройками — пресет лишь подсказка для UI.',
