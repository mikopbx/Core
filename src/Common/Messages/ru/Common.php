...
return [
    ...
    'adv_S3ConnectionFailed' => 'Ошибка подключения к хранилищу S3. Проверьте настройки подключения на странице "Хранилище → S3".',
    'adv_S3ClientInitializationFailed' => 'Не удалось инициализировать S3 клиент. Проверьте настройки на странице "Хранилище → S3".',
