...
<br>Järjestelmä tallentaa kaikki tällä hetkellä verkkokortin läpi kulkevat paketit lisäanalyysiä varten.',
    ...
    'adv_S3ConnectionFailed' => 'S3-tallennusyhteysvirhe: %error%. Päätepiste: %endpoint%, Säiliö: %bucket%',
    'adv_S3ClientInitializationFailed' => 'S3-asiakkaan alustaminen epäonnistui: %error%. Päätepiste: %endpoint%',
