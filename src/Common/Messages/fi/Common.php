...
<br>Järjestelmä tallentaa kaikki tällä hetkellä verkkokortin läpi kulkevat paketit lisäanalyysiä varten.',
    ...
    'st_DiskSpeedWrite' => 'Kirjoitus',
    'st_DiskSpeedRead' => 'Luku',
    'st_DiskSpeedUnit' => 'MB/s',
    'st_DiskSpeedRunButton' => 'Mittaa levyn nopeus',
    'st_DiskSpeedRunning' => 'Mitataan…',
    'st_DiskSpeedNoData' => 'Ei vielä mitattu',
    'st_Of' => '/',
    ...
    'storage_s3_preset_custom' => 'Muu / manuaalinen määritys',
    'storage_s3_preset_aws_hint' => 'Käytä AWS-aluetta, jolle bucket luotiin (esim. eu-central-1).',
    'storage_s3_preset_minio_hint' => 'Path-style on käytössä. Alue voi pysyä us-east-1, MinIO jättää sen huomiotta.',
    'storage_s3_preset_garage_hint' => 'Path-style on käytössä. Alueen on vastattava Garage-konfiguraation arvoa (oletus: garage).',
    'storage_s3_preset_ceph_hint' => 'Path-style on käytössä. Alue on klusterin alustuksessa määritetty zonegroup.',
    'storage_s3_preset_wasabi_hint' => 'Käytetään virtual-hosted-osoitusta. Päätepiste riippuu alueesta (esim. https://s3.eu-central-1.wasabisys.com).',
    'storage_s3_preset_digitalocean_hint' => 'Päätepiste sisältää alueen (nyc3, ams3, sgp1, fra1). Käytetään virtual-hosted-osoitusta.',
    'storage_s3_preset_yandex_hint' => 'Alue on aina ru-central1. Päätepiste: https://storage.yandexcloud.net.',
    'storage_s3_preset_vkcloud_hint' => 'Päätepiste riippuu alueesta (ru-msk, ru-spb).',
    'storage_s3_preset_selectel_hint' => 'Päätepiste ja alue ilmoitetaan samalla arvolla (esim. ru-1). Käytetään virtual-hosted-osoitusta.',
    'storage_s3_preset_custom_hint' => 'Anna yhteysasetukset manuaalisesti. Ota path-style-URL:t käyttöön, jos palveluntarjoaja sitä vaatii (MinIO, Garage, Ceph RadosGW jne.).',
    'st_S3ErrorCodePrefix' => 'AWS-virhekoodi',
    'st_S3ErrorTypePrefix' => 'Virhetyyppi',
    ...
    'st_tooltip_s3_preset_header' => 'S3-palveluntarjoajan preset',
    'st_tooltip_s3_preset_desc' => 'Valitse palveluntarjoaja, niin oikeat arvot päätepisteelle, alueelle ja osoitustilalle (path-style: MinIO, Garage, Ceph) täyttyvät automaattisesti. Moottori käyttää edelleen eksplisiittisiä asetuksia — preset on vain käyttöliittymän vihje.',
