...
return [
    ...
    'ext_ConfigureModule' => 'Configure module',
    'ext_ConfirmUpdate' => 'Apply update',
    ...
    'ext_FailedToLoadChangelog' => 'Failed to load the changelog from the repository. Try again later.',
    ...
    'ext_LoadingChangelog' => 'Loading changelog…',
    ...
    'ext_ModuleTypeAi' => 'AI / Speech processing',
    'ext_ModuleTypeAll' => 'All categories',
    'ext_ModuleTypeCallFeature' => 'Call features',
    'ext_ModuleTypeCti' => 'CTI / CRM integrations',
    'ext_ModuleTypeFilter' => 'Module category',
    'ext_ModuleTypeGeneral' => 'General',
    'ext_ModuleTypeLanguagepack' => 'Language packs',
    'ext_ModuleTypeSecurity' => 'Security',
    'ext_ModuleTypeUtility' => 'Utilities',
    ...
    'ext_NoChangelogAvailable' => 'No changelog provided for this release.',
    ...
    'ext_UpdateAllModulesChangelogIntro' => 'Select the modules you want to update. Expand each entry to review its changelog before confirming.',
    ...
    'ext_UpdateAllModulesShort' => 'Update all',
    'ext_UpdateAllModulesTitle' => 'Updating all modules',
    'ext_UpdateChangelogIntro' => 'Module <b>%name%</b> will be updated from version <b>%from%</b> to <b>%to%</b>. Review the changes below before confirming.',
