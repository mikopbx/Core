...
return [
    ...
    'pr_DefaultUser' => 'Einige Anbieter benötigen einen zusätzlichen Autorisierungsnamen (Standardbenutzer), der sich vom Login unterscheidet',
    'pr_FromUser' => 'Bei einigen Anbietern müssen Sie zusätzlich ein anderes Feld (vom Benutzer) als die Anmeldung angeben',
    'pr_FromDomain' => 'Einige Anbieter benötigen einen zusätzlichen Wert (fromdomain)',
 ...
 Nur falls keine Anrufe zustande kommen oder der Provider spezielle Einstellungen erfordert, sollten diese Felder genutzt werden. Dabei sind die Vorgaben des Providers zu beachten.</div>',
    ...
    'gs_ValidateWeakSSHPassword' => 'Sehr einfaches SSH-Passwort angegeben',
    'gs_ValidateSSHPasswordsFieldDifferent' => 'SSH-Passwort falsch eingegeben',
    ...
    'cf_Mode' => 'Einstellung',
    'mo_BeforeDeleteFirst' => 'Es gibt Links zum Objekt - %represent%',
...
Haben Sie Ihen Lizenzschlüssel vergessen, suchen Sie in Ihrem Posteingang nach \'lic@miko.ru\'.<br>
...
Ein Coupon kann nur einmal aktiviert werden und verfällt danach.
 ...
 Verwenden Sie den zuvor von der Adresse lic@miko.ru an Sie gesendeten Schlüssel oder geben Sie den richtigen Firmennamen ein.',
...
<br>Es wird ein Auszug der System-Log-Dateien erstellt und als Archiv zum Download bereitgestellt.</div>',
    ...
    'sd_CapturePcap' => 'Protokolle erfassen',
