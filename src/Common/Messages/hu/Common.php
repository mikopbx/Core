...
<br>A rendszer elmenti a hálózati kártyán jelenleg áthaladó összes csomagot további elemzés céljából.',
    ...
    'adv_S3ConnectionFailed' => 'S3 Tárolókapcsolati hiba: %error%. Végpont: %endpoint%, Vödör: %bucket%',
    'adv_S3ClientInitializationFailed' => 'Nem sikerült inicializálni az S3 klienst: %error%. Végpont: %endpoint%',
