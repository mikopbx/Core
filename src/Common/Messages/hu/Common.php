...
<br>A rendszer elmenti a hálózati kártyán jelenleg áthaladó összes csomagot további elemzés céljából.',
    ...
    'sf_AudioFileMissingWarning' => 'A hangfájl hiányzik a lemezről. Kérjük, töltse fel újra.',
    'sf_ColumnFile' => 'Név',
    ...
    'st_DiskSpeedWrite' => 'Írás',
    'st_DiskSpeedRead' => 'Olvasás',
    'st_DiskSpeedUnit' => 'MB/s',
    'st_DiskSpeedRunButton' => 'Lemezsebesség mérése',
    'st_DiskSpeedRunning' => 'Mérés folyamatban…',
    'st_DiskSpeedNoData' => 'Még nincs mérve',
    'st_Of' => 'ból',
    ...
    'storage_s3_preset_label' => 'S3-tárhelyszolgáltató',
    'storage_s3_preset_placeholder' => 'Válasszon szolgáltatót',
    ...
    'storage_s3_preset_custom' => 'Egyéb / kézi beállítás',
    'storage_s3_preset_aws_hint' => 'Használja azt az AWS-régiót, amelyben a bucket létrejött (pl. eu-central-1).',
    'storage_s3_preset_minio_hint' => 'A path-style be van kapcsolva. A régió maradhat us-east-1, a MinIO nem veszi figyelembe.',
    'storage_s3_preset_garage_hint' => 'A path-style be van kapcsolva. A régiónak meg kell egyeznie a Garage konfigurációjában beállított értékkel (alapértelmezett: garage).',
    'storage_s3_preset_ceph_hint' => 'A path-style be van kapcsolva. A régió a fürt inicializálásakor megadott zonegroup neve.',
    'storage_s3_preset_wasabi_hint' => 'Virtual-hosted címzést használunk. A végpont a régiótól függ (pl. https://s3.eu-central-1.wasabisys.com).',
    'storage_s3_preset_digitalocean_hint' => 'A végpont tartalmazza a régiót (nyc3, ams3, sgp1, fra1). Virtual-hosted címzést használunk.',
    'storage_s3_preset_yandex_hint' => 'A régió mindig ru-central1. Végpont: https://storage.yandexcloud.net.',
    'storage_s3_preset_vkcloud_hint' => 'A végpont a régiótól függ (ru-msk, ru-spb).',
    'storage_s3_preset_selectel_hint' => 'A végpont és a régió ugyanazt az értéket veszi fel (pl. ru-1). Virtual-hosted címzést használunk.',
    'storage_s3_preset_custom_hint' => 'Adja meg a kapcsolódási paramétereket kézzel. Engedélyezze a path-style URL-eket, ha a szolgáltató ezt kéri (MinIO, Garage, Ceph RadosGW stb.).',
    'st_S3ErrorCodePrefix' => 'AWS hibakód',
    'st_S3ErrorTypePrefix' => 'Hibatípus',
    ...
    'st_tooltip_s3_preset_header' => 'S3-szolgáltatói preset',
    'st_tooltip_s3_preset_desc' => 'Válasszon szolgáltatót a helyes endpoint, régió és címzési mód (path-style MinIO/Garage/Ceph esetén) automatikus kitöltéséhez. A motor továbbra is az explicit beállításokkal dolgozik — a preset csak felhasználói felületi javaslat.',
