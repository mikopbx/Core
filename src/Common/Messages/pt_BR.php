...
return [
    ...
    'ir_RuleDescriptionWithoutProvider' => 'Uma chamada sem conexão com um provedor para o número <b>%number%</b> será direcionada para&nbsp&nbsp&nbsp<b>%callerid%</b>',
...
<br>O sistema salvará todos os pacotes que passarem neste momento pela placa de rede para posterior análise.',
    ...
    'gs_SIPAuthPrefix' => 'Prefixo do nome de usuário para autorização. O prefixo será adicionado ao final do nome de usuário.',
    'gs_SIPAuthPrefixInvalid' => 'O prefixo do nome de usuário Auth só pode conter letras latinas.',
    ...
    'gs_SSH_ID_RSA_PUB' => 'Chave pública SSH RSA',
