...
class AGI {
     ...
     */
    function getData($filename, $timeout = NULL, $max_digits = NULL){
     ...
     * This differs from other commands with return DTMF as numbers representing ASCII characters.
     */
    function fastpass_getData(&$buffer, $filename, $timeout = NULL, $max_digits = NULL){
    ...
    function menu($choices, $timeout = 2000){
        ...
        while (is_null($choice)) {
            ...
            if (is_null($choice)) {
                $ret = $this->getData('beep', $timeout, 1);
