...
class PbxConf extends SystemConfigClass
{
    ...
    /**
     * Safely restarts Asterisk via monit stop/start cycle.
     *
     * Unlike 'core restart now' which re-execs and risks duplicate instances,
     * this stops Asterisk cleanly and lets monit start a fresh process.
     *
     * @param bool $hangupChannels Whether to hangup all channels before stopping.
     */
    public static function safeRestart(bool $hangupChannels = false): void
    {
