 ...
 *
 * Comprehensive SIP providers management following Google API Design Guide patterns.
...
class RestController extends BaseRestController
{
    ...
    /**
     * Get list of all SIP providers with pagination and filtering
     *
     * @route GET /pbxcore/api/v3/sip-providers
     */
    #[ApiDataSchema(
    ...
    #[ApiOperation(
        summary: 'rest_sipp_GetList',
        description: 'rest_sipp_GetListDesc',
        operationId: 'getSipProvidersList'
    )]
    #[ApiParameter(
        name: 'limit',
        type: 'integer',
    ...
    #[ApiParameter(
        ...
        in: ParameterLocation::QUERY,
        enum: ['description', 'host', 'disabled'],
        default: 'description',
        example: 'description'
    )]
    #[ApiParameter(
    ...
    /**
     * Get a specific SIP provider by ID
     *
     * @route GET /pbxcore/api/v3/sip-providers/{id}
     */
    #[ApiDataSchema(
        schemaClass: DataStructure::class,
        type: 'detail'
    ...
    #[ApiOperation(
        summary: 'rest_sipp_GetRecord',
        description: 'rest_sipp_GetRecordDesc',
        operationId: 'getSipProviderById'
    )]
    #[ApiParameter('id', 'string', 'rest_param_id', ParameterLocation::PATH, required: true, pattern: '^[A-Za-z0-9_-]+$', example: 'SIP-PROV-123')]
     ...
     *
     * @route POST /pbxcore/api/v3/sip-providers
     */
    #[ApiDataSchema(
        schemaClass: DataStructure::class,
        type: 'detail'
    ...
    #[ApiOperation(
        summary: 'rest_sipp_Create',
        description: 'rest_sipp_CreateDesc',
        operationId: 'createSipProvider'
    )]
    #[ApiParameter('description', 'string', 'rest_param_prov_description', ParameterLocation::QUERY, required: true, maxLength: 255, example: 'Main SIP Provider')]
    #[ApiParameter('host', 'string', 'rest_param_prov_host', ParameterLocation::QUERY, required: true, maxLength: 255, example: 'sip.provider.com')]
    ...
    /**
     * Update an existing SIP provider (full replacement)
     *
     * @route PUT /pbxcore/api/v3/sip-providers/{id}
     */
    #[ApiDataSchema(
        schemaClass: DataStructure::class,
        type: 'detail'
    ...
    #[ApiOperation(
        summary: 'rest_sipp_Update',
        description: 'rest_sipp_UpdateDesc',
        operationId: 'updateSipProvider'
    )]
    #[ApiParameter('id', 'string', 'rest_param_id', ParameterLocation::PATH, required: true, pattern: '^[A-Za-z0-9_-]+$', example: 'SIP-PROV-123')]
    #[ApiParameter('description', 'string', 'rest_param_prov_description', ParameterLocation::QUERY, required: true, maxLength: 255, example: 'Updated SIP Provider')]
    #[ApiParameter('host', 'string', 'rest_param_prov_host', ParameterLocation::QUERY, required: true, maxLength: 255, example: 'new.sip.provider.com')]
    ...
    /**
     * Partially update an existing SIP provider
     *
     * @route PATCH /pbxcore/api/v3/sip-providers/{id}
     */
    #[ApiDataSchema(
        schemaClass: DataStructure::class,
        type: 'detail'
    ...
    #[ApiOperation(
        summary: 'rest_sipp_Patch',
        description: 'rest_sipp_PatchDesc',
        operationId: 'patchSipProvider'
    )]
    #[ApiParameter('id', 'string', 'rest_param_id', ParameterLocation::PATH, required: true, pattern: '^[A-Za-z0-9_-]+$', example: 'SIP-PROV-123')]
     ...
     *
     * @route DELETE /pbxcore/api/v3/sip-providers/{id}
     */
    #[ApiOperation(
        summary: 'rest_sipp_Delete',
        description: 'rest_sipp_DeleteDesc',
        operationId: 'deleteSipProvider'
    )]
    #[ApiParameter('id', 'string', 'rest_param_id', ParameterLocation::PATH, required: true, pattern: '^[A-Za-z0-9_-]+$', example: 'SIP-PROV-123')]
    ...
    /**
     * Get default template for new SIP provider
     *
     * @route GET /pbxcore/api/v3/sip-providers:getDefault
     */
    #[ApiDataSchema(
        schemaClass: DataStructure::class,
        type: 'detail'
    ...
    #[ApiOperation(
        summary: 'rest_sipp_GetDefault',
        description: 'rest_sipp_GetDefaultDesc',
        operationId: 'getSipProviderDefault'
    )]
    ...
    /**
     * Get registration statuses for all SIP providers
     *
     * @route GET /pbxcore/api/v3/sip-providers:getStatuses
     */
    #[ApiOperation(
        summary: 'rest_sipp_GetStatuses',
        description: 'rest_sipp_GetStatusesDesc',
        operationId: 'getSipProvidersStatuses'
    )]
    ...
    /**
     * Get registration status for specific SIP provider
     *
     * @route GET /pbxcore/api/v3/sip-providers/{id}:getStatus
     */
    #[ApiOperation(
        summary: 'rest_sipp_GetStatus',
        description: 'rest_sipp_GetStatusDesc',
        operationId: 'getSipProviderStatus'
    )]
    #[ApiParameter('id', 'string', 'rest_param_id', ParameterLocation::PATH, required: true, pattern: '^[A-Za-z0-9_-]+$', example: 'SIP-PROV-123')]
    ...
    /**
     * Get connection history for all SIP providers
     *
     * @route GET /pbxcore/api/v3/sip-providers:getHistory
     */
    #[ApiOperation(
        summary: 'rest_sipp_GetHistory',
        description: 'rest_sipp_GetHistoryDesc',
        operationId: 'getSipProvidersHistory'
    )]
    #[ApiParameter(
        name: 'dateFrom',
        type: 'string',
    ...
    /**
     * Get statistics for all SIP providers
     *
     * @route GET /pbxcore/api/v3/sip-providers:getStats
     */
    #[ApiOperation(
        summary: 'rest_sipp_GetStats',
        description: 'rest_sipp_GetStatsDesc',
        operationId: 'getSipProvidersStats'
    )]
    ...
    /**
     * Copy an existing SIP provider with a new description
     *
     * @route GET /pbxcore/api/v3/sip-providers/{id}:copy
     */
    #[ApiDataSchema(
        schemaClass: DataStructure::class,
        type: 'detail'
    ...
    #[ApiOperation(
        summary: 'rest_sipp_Copy',
        description: 'rest_sipp_CopyDesc',
        operationId: 'copySipProvider'
    )]
    #[ApiParameter('id', 'string', 'rest_param_id', ParameterLocation::PATH, required: true, pattern: '^[A-Za-z0-9_-]+$', example: 'SIP-PROV-123')]
    ...
    /**
     * Force registration check for specific SIP provider
     *
     * @route POST /pbxcore/api/v3/sip-providers/{id}:forceCheck
     */
    #[ApiOperation(
        summary: 'rest_sipp_ForceCheck',
        description: 'rest_sipp_ForceCheckDesc',
        operationId: 'forceCheckSipProvider'
    )]
    #[ApiParameter('id', 'string', 'rest_param_id', ParameterLocation::PATH, required: true, pattern: '^[A-Za-z0-9_-]+$', example: 'SIP-PROV-123')]
     ...
     *
     * @route POST /pbxcore/api/v3/sip-providers/{id}:updateStatus
     */
    #[ApiOperation(
        summary: 'rest_sipp_UpdateStatus',
        description: 'rest_sipp_UpdateStatusDesc',
        operationId: 'updateSipProviderStatus'
    )]
    #[ApiParameter('id', 'string', 'rest_param_id', ParameterLocation::PATH, required: true, pattern: '^[A-Za-z0-9_-]+$', example: 'SIP-PROV-123')]
