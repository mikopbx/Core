...
/**
 * PUT controller for API keys management
 * 
 * @RoutePrefix("/pbxcore/api/v2/api-keys")
 * 
 * @examples
 * curl -X PUT http://127.0.0.1/pbxcore/api/v2/api-keys/saveRecord/3 \
 *   -d "description=Updated API Key&networkfilterid=none&allowed_paths=[]"
 * 
...
class PutController extends BaseController
{
     ...
     * @param string|null $id API key ID for update operations
     * 
     * Updates existing API key record
     * @Put("/saveRecord/{id}")
     * 
     * @return void
     */
