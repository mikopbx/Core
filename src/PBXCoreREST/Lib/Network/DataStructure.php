...
class DataStructure extends AbstractDataStructure implements OpenApiSchemaProvider
{
    ...
    public static function getListItemSchema(): array
    {
        ...
        // ✨ Inherit list-specific fields (NO duplication!)
    ...
    public static function getParameterDefinitions(): array
    {
        return [
            'request' => [
                ...
                'interface' => [
                    'type' => 'string',
                    'description' => 'rest_param_net_interface',
                    'maxLength' => 50,
                    'sanitize' => 'string',
                    'example' => 'eth0'
                ],
                'name' => [
                    'type' => 'string',
                    'description' => 'rest_param_net_name',
                    'maxLength' => 100,
                    'sanitize' => 'string',
                ...
                'vlanid' => [
                    'type' => 'string',
                    'description' => 'rest_param_net_vlanid',
                    'pattern' => '^[0-9]{1,4}$',
                    'sanitize' => 'string',
                    'example' => '100'
                ],
                ...
                'ipaddr' => [
                    'type' => 'string',
                    'description' => 'rest_param_net_ipaddr',
                    'pattern' => '^(?:[0-9]{1,3}\.){3}[0-9]{1,3}$',
                    'sanitize' => 'string',
                    'example' => '192.168.1.1'
                ],
                'subnet' => [
                    'type' => 'string',
                    'description' => 'rest_param_net_subnet',
                    'sanitize' => 'string',
                ...
                'dhcp' => [
                    'type' => 'string',
                    'description' => 'rest_param_net_dhcp',
                    'enum' => ['0', '1'],
                    'sanitize' => 'string',
                    'example' => '0'
                ],
                'internet' => [
                    'type' => 'string',
                    'description' => 'rest_param_net_internet',
                    'enum' => ['0', '1'],
                    'sanitize' => 'string',
                    'example' => '1'
                ],
                'disabled' => [
                    'type' => 'string',
                    'description' => 'rest_param_net_disabled',
                    'enum' => ['0', '1'],
                    'sanitize' => 'string',
                    'example' => '0'
                ],
                ...
                'topology' => [
                    'type' => 'string',
                    'description' => 'rest_param_net_topology',
                    'enum' => ['public', 'private'],
                    'sanitize' => 'string',
                    'example' => 'private'
                ],
                'extipaddr' => [
                    'type' => 'string',
                    'description' => 'rest_param_net_extipaddr',
                    'pattern' => '^(?:[0-9]{1,3}\.){3}[0-9]{1,3}$',
                    'sanitize' => 'string',
                    'example' => '203.0.113.1'
                ],
                'exthostname' => [
                    'type' => 'string',
                    'description' => 'rest_param_net_exthostname',
                    'maxLength' => 255,
                    'sanitize' => 'string',
                    'example' => 'pbx.example.com'
                ],
                // Bulk configuration (for saveConfig)
                'interfaces' => [
                    'type' => 'array',
            ...
            'response' => [
                ...
                // Derived fields (booleans computed from string flags)
                'isDeletable' => [
                    'type' => 'boolean',
            ...
            // ========== RELATED SCHEMAS ==========
            'related' => [
                // Complete network interface schema (combines list and detail fields)
                'NetworkInterface' => [
                    'type' => 'object',
                    'required' => ['id', 'interface', 'name'],
