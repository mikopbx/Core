...
{#    </div>#}
    ...
    <div class="ui right aligned selection dropdown search item" id="top-menu-search">
        ...
        <div class="ui inverted transparent icon input">
            <input class="search" autocomplete="off" tabindex="0" placeholder="{{ t._("topMenu_SearchPlaceholder") }}" value="">
            <i class="search link icon"></i>
        </div>
        <div class="results"></div>
    </div>
    <a class="item" href="{{ urlToWiki }}" target="_blank" data-content="{{ t._("GoToWikiDocumentation") }}" data-variation="wide">
        <i class="question icon"></i>
    </a>
    <a class="item" href="{{ urlToSupport }}" target="_blank"><i class="icon conversation"></i> {{ t._("topMenu_Support") }}</a>
