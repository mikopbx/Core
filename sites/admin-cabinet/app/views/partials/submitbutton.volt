...
<div class="ui positive right floated buttons" >
    ...
    <div class="ui floating dropdown icon large button" id="dropdownSubmit">
        ...
        <div class="menu">
            <div class="item" data-value="SaveSettings"><i class="icons"><i class="save icon"></i></i> {{ t._('bt_SaveSettings') }}</div>
            <div class="item" data-value="SaveSettingsAndAddNew"><i class="icons"><i class="save icon"></i><i class="add corner icon"></i></i> {{ t._('bt_SaveSettingsAndAddNew') }}</div>
            <div class="item" data-value="SaveSettingsAndExit"><i class="icons"><i class="save icon"></i><i class="list corner icon"></i></i> {{ t._('bt_SaveSettingsAndExit') }}</div>
        </div>
    </div>
</div>
{% else %}
