...
description: Инспекция Docker контейнеров MikoPBX (mikopbx_php83/mikopbx_php74) для получения параметров подключения (IP, порты), перезапуска контейнеров и управления воркерами. Использовать при отладке контейнеров, запуске тестов или устранении проблем с подключением.
...
.claude/skills/container-inspector/scripts/get-container-info.sh mikopbx_php83
...
# List workers
.claude/skills/container-inspector/scripts/restart-worker.sh mikopbx_php83 list

# Restart specific worker
.claude/skills/container-inspector/scripts/restart-worker.sh mikopbx_php83 WorkerApiCommands
```

See **[reference/QUICKSTART.md](reference/QUICKSTART.md)** for command reference card.
...
See **[examples/examples.md](examples/examples.md)** for more detailed scenarios and usage patterns.
...
- **[reference/QUICKSTART.md](reference/QUICKSTART.md)** - Quick reference card with most common commands
- **[examples/examples.md](examples/examples.md)** - Detailed usage examples and scenarios
- **[reference/port-reference.md](reference/port-reference.md)** - Complete port mapping guide
- **[reference/troubleshooting.md](reference/troubleshooting.md)** - Solutions for common issues
- **[reference/README.md](reference/README.md)** - Overview and quick start
...
See **[reference/troubleshooting.md](reference/troubleshooting.md)** for detailed error solutions.
