---
name: js-style
description: Валидация и руководство по форматированию JavaScript кода согласно стандартам ES6+ и проектным стандартам MikoPBX. Использовать при написании или ревью JavaScript кода, проверке соответствия стилю кода или когда пользователь упоминает JS стиль, форматирование кода или best practices.
