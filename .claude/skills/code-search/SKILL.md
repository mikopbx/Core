---
name: code-search
description: Продвинутый синтаксически-осознанный поиск кода используя ast-grep для PHP и JavaScript паттернов. Использовать при поиске классов, методов или структур кода, рефакторинге кода или изучении архитектуры кодовой базы.
